...
const Navbar = () => {
  return (
    <div className="flex justify-center w-full fixed">
      ...
      <div className="w-full max-w-[1200px] backdrop-blur-md bg-[#041e24]/50 border border-[#197686] rounded-3xl p-4 md:px-10 mx-4 md:mx-10 my-4">
        {/* Navbar Container */}
        <nav className="flex items-center justify-between w-full">
          ...
          <button className="bg-white text-black p-2 flex md:p-3 w-[150px] md:w-[150px] rounded-xl text-sm md:text-base">
            MY TICKETS
            <Image
              src={arrow}
